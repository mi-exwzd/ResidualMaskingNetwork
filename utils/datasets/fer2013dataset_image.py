...
class FER2013(Dataset):
    def __init__(self, stage, configs, tta=False, tta_size=48):
        ...
        self._data = pd.read_csv(os.path.join(configs["data_path"], "FER2013/{}.csv".format(stage)))

        self._paths = self._data["path"].tolist()
    ...
    def __getitem__(self, idx):
        img_path = os.path.join(self._configs["data_path"], self._paths[idx])
